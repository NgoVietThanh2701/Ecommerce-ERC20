...
const showShortAddress = (address, amount) => {
...
const SuccessModal = ({ txHash, title, setIsOpenModal }) => {

   return (
      <div className='z-10 bg-half-transparent nav-item w-screen fixed top-0 left-0 right-0 bottom-0 flex justify-center'>
